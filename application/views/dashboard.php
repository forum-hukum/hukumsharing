                            ...
                            <div class="post">
                                <div class="wrap-ut pull-left">
                                    <div class="userinfo pull-left">
                                        ...
                                        <div class="icons">
                                            <img src="<?php echo base_url()?>f_style/images/icon1.jpg" alt="" /><img src="<?php echo base_url()?>f_style/images/icon4.jpg" alt="" /><img src="<?php echo base_url()?>f_style/images/icon6.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div class="posttext pull-left">
                                  ...
                                  <ul class="cats">
                                        <li>
											<table>
												<tr>
													<td>
														<img class="consultant-profile" src="images/avatar3.jpg" alt="">
													</td>
													<td>
